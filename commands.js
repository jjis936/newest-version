...
const CONFIG = {
    ...
    TICKET_SERVICES: [
        { label: "Nuke Services", value: "nuke", emoji: { id: "1524910404814503936" } },
...
async function askAI(question){
    ...
    if(!process.env.ANTHROPIC_API_KEY){
        return "⚠️ AI support isn't configured yet - staff needs to set ANTHROPIC_API_KEY. Please open a ticket instead.";
    }
    ...
    try{
        ...
        return textBlock ? textBlock.text : "⚠️ Got an unexpected response. Please open a ticket instead.";
...
const slashCommands = [
    ...
    // -- Self-diagnostic status command (the "surprise") --------------------
    {
        ...
        async execute(interaction){
            ...
            checks.push([`ANTHROPIC_API_KEY`, !!process.env.ANTHROPIC_API_KEY]);
